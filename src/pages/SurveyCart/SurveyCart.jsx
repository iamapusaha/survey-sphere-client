...
const SurveyCart = ({ survey }) => {
    const { _id, description, title, image, totalVote, like } = survey;
    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-6 min-w-96 h-[550px]">
            ...
            <div className="flex justify-between items-center my-4">
                <div>
                    <span className="text-gray-900 font-bold">{totalVote}</span>
                    <span className="text-gray-600 ml-1">Votes</span>
                </div>
                <div>
                    <span className="text-gray-900 font-bold">{like}</span>
